...
When populating the authorization-signature table, enter Party A's Thai and Chinese legal names only. Keep its registration number and registered address in the party-information section; do not repeat them in the signature table.
